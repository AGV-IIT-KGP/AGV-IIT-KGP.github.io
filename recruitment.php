...
<!-- CONTENT 
	...
	<div class="content shortcodes gray-content" style="padding-bottom: 10px;">
		<div class="layout">
			...
			<h1 class="centered semibold uppercase" style="padding-top: 10px; padding-bottom: 10px;">Recruitment FAQ</h1>
			...
			<div class="row">
				...
				<div class="row-item col-1_3 sidebar">
					...
					<div class="b-box gray margin-40" style="padding: 20px 25px 0px;">
						...
						<p>
							<a href="contact.php" class="btn colored"><i class="icon-envelope"></i>Contact Us</a>
						</p>
					</div>
					<!-- End Information Box -->
					<!-- Latest Projects -->
